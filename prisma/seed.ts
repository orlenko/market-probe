...
async function main() {
  ...
  const project1 = await prisma.project.upsert({
    ...
    create: {
      ...
      description: 'A smart writing companion that helps you create better content faster using advanced AI technology.',
      status: 'ACTIVE',
      pageConfigs: {
        create: {
          templateConfig: {
            headline: "Write Better Content 10x Faster",
            subheadline: "Meet your AI writing assistant that helps entrepreneurs, marketers, and content creators produce high-quality content in minutes, not hours.",
            ctaText: "Join the Waitlist",
            features: [
              {
                title: "AI-Powered Writing",
                description: "Generate blog posts, emails, and social media content with advanced AI"
              },
              {
  ...
  const project2 = await prisma.project.upsert({
    ...
    create: {
      ...
      description: 'Biodegradable packaging solutions for e-commerce businesses that care about the environment.',
      ...
      pageConfigs: {
        create: {
          templateConfig: {
            ...
            subheadline: "Switch to 100% biodegradable packaging for your e-commerce business. Same protection, zero environmental impact.",
  ...
  for (let day = 0; day < 7; day++) {
    ...
    for (let i = 0; i < pageViewsCount; i++) {
      analyticsEvents.push({
        ...
        referrer: Math.random() > 0.7 ? 'https://twitter.com' : Math.random() > 0.5 ? 'https://google.com' : null,
