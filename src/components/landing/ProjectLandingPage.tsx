  ...
  return (
    <LandingPageLayout designConfig={designConfig} project={project}>
      ...
      {templateConfig.socialProof && (
        <SocialProofSection
          socialProof={templateConfig.socialProof}
          designConfig={designConfig}
        />
      )}
      ...
      <EmailSignupSection designConfig={designConfig}>
        <div className="max-w-md mx-auto">
          <h2 className="text-2xl font-bold text-center mb-6" style={{ color: designConfig.textColor }}>
      ...
      {/* FAQ Section */}
      {templateConfig.additionalSections?.faq && templateConfig.additionalSections.faq.length > 0 && (
        <section className="py-16">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2 className="text-3xl font-bold text-center mb-12" style={{ color: designConfig.textColor }}>
              Frequently Asked Questions
            </h2>
            <div className="space-y-8">
              {templateConfig.additionalSections.faq.map((faq, index) => (
                <div key={index} className="border-b border-gray-200 pb-6">
                  <h3 className="text-lg font-semibold mb-3" style={{ color: designConfig.textColor }}>
                    {faq.question}
                  </h3>
